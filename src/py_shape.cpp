...
void bindShape(nb::module_& m) {
    ...
    nb::class_<PxShape>(m, "PxShape")
            ...
            .def("setGeometry", &PxShape::setGeometry, "geometry"_a)
            .def("getGeometry", &PxShape::getGeometry, nb::rv_policy::reference)
            .def("getActor", &PxShape::getActor, nb::rv_policy::reference)
            .def_prop_rw("localPose", &PxShape::getLocalPose, &PxShape::setLocalPose)
            .def_prop_rw("simulationFilterData", &PxShape::getSimulationFilterData, &PxShape::setSimulationFilterData)
            .def_prop_rw("queryFilterData", &PxShape::getQueryFilterData, &PxShape::setQueryFilterData)
            ...
            .def_prop_rw("contactOffset", &PxShape::getContactOffset, &PxShape::setContactOffset)
            .def_prop_rw("restOffset", &PxShape::getRestOffset, &PxShape::setRestOffset)
            .def_prop_rw("densityForFluid", &PxShape::getDensityForFluid, &PxShape::setDensityForFluid)
            .def_prop_rw("torsionalPatchRadius", &PxShape::getTorsionalPatchRadius, &PxShape::setTorsionalPatchRadius)
            .def_prop_rw("minTorsionalPatchRadius", &PxShape::getMinTorsionalPatchRadius,
                         &PxShape::setMinTorsionalPatchRadius)
            .def("getGPUIndex", &PxShape::getGPUIndex)
            .def("setFlag", &PxShape::setFlag, "flag"_a, "value"_a)
            .def_prop_rw("flags", &PxShape::getFlags, &PxShape::setFlags)
            .def("isExclusive", &PxShape::isExclusive)
            .def_prop_rw("name", &PxShape::getName, &PxShape::setName);
