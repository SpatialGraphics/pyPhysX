...
class PxActor:
    ...
    def setActorFlags(self, flags: int) -> None: ...

    def getActorFlags(self) -> int: ...
...
class PxArticulationReducedCoordinate:
    ...
    def setArticulationFlags(self, arg: int, /) -> None: ...

    def setArticulationFlag(self, arg0: PxArticulationFlag, arg1: bool, /) -> None: ...

    def getArticulationFlags(self) -> int: ...
    ...
    def applyCache(self, cache: PxArticulationCache, flags: int, autowake: bool = True) -> None: ...

    def copyInternalStateToCache(self, cache: PxArticulationCache, flags: int) -> None: ...
    ...
    def updateKinematic(self, flags: int) -> None: ...
...
class PxConstraint:
    ...
    def getExternalReference(self, arg: int, /) -> types.CapsuleType: ...
...
class PxPBDParticleSystem(PxActor):
    ...
    def createPhase(self, arg0: PxPBDMaterial, arg1: int, /) -> int: ...
...
class PxRigidDynamic(PxRigidBody):
    ...
    def setRigidDynamicLockFlags(self, arg: int, /) -> None: ...

    def setRigidDynamicLockFlag(self, arg0: PxRigidDynamicLockFlag, arg1: bool, /) -> None: ...

    def getRigidDynamicLockFlags(self, arg: int, /) -> int: ...
...
class PxSceneDesc:
    ...
    @property
    def simulationEventCallback(self) -> "physx::PxSimulationEventCallback": ...

    @simulationEventCallback.setter
    def simulationEventCallback(self, arg: "physx::PxSimulationEventCallback", /) -> None: ...

    @property
    def contactModifyCallback(self) -> "physx::PxContactModifyCallback": ...

    @contactModifyCallback.setter
    def contactModifyCallback(self, arg: "physx::PxContactModifyCallback", /) -> None: ...

    @property
    def ccdContactModifyCallback(self) -> "physx::PxCCDContactModifyCallback": ...

    @ccdContactModifyCallback.setter
    def ccdContactModifyCallback(self, arg: "physx::PxCCDContactModifyCallback", /) -> None: ...
    ...
    @property
    def filterCallback(self) -> "physx::PxSimulationFilterCallback": ...

    @filterCallback.setter
    def filterCallback(self, arg: "physx::PxSimulationFilterCallback", /) -> None: ...

    @property
    def kineKineFilteringMode(self) -> "physx::PxPairFilteringMode::Enum": ...

    @kineKineFilteringMode.setter
    def kineKineFilteringMode(self, arg: "physx::PxPairFilteringMode::Enum", /) -> None: ...

    @property
    def staticKineFilteringMode(self) -> "physx::PxPairFilteringMode::Enum": ...

    @staticKineFilteringMode.setter
    def staticKineFilteringMode(self, arg: "physx::PxPairFilteringMode::Enum", /) -> None: ...

    @property
    def broadPhaseType(self) -> "physx::PxBroadPhaseType::Enum": ...

    @broadPhaseType.setter
    def broadPhaseType(self, arg: "physx::PxBroadPhaseType::Enum", /) -> None: ...

    @property
    def broadPhaseCallback(self) -> "physx::PxBroadPhaseCallback": ...

    @broadPhaseCallback.setter
    def broadPhaseCallback(self, arg: "physx::PxBroadPhaseCallback", /) -> None: ...

    @property
    def limits(self) -> "physx::PxSceneLimits": ...

    @limits.setter
    def limits(self, arg: "physx::PxSceneLimits", /) -> None: ...

    @property
    def frictionType(self) -> "physx::PxFrictionType::Enum": ...

    @frictionType.setter
    def frictionType(self, arg: "physx::PxFrictionType::Enum", /) -> None: ...

    @property
    def solverType(self) -> "physx::PxSolverType::Enum": ...

    @solverType.setter
    def solverType(self, arg: "physx::PxSolverType::Enum", /) -> None: ...
    ...
    @property
    def cpuDispatcher(self) -> "physx::PxCpuDispatcher": ...

    @cpuDispatcher.setter
    def cpuDispatcher(self, arg: "physx::PxCpuDispatcher", /) -> None: ...

    @property
    def cudaContextManager(self) -> "physx::PxCudaContextManager": ...

    @cudaContextManager.setter
    def cudaContextManager(self, arg: "physx::PxCudaContextManager", /) -> None: ...
    ...
    @property
    def gpuDynamicsConfig(self) -> "physx::PxGpuDynamicsMemoryConfig": ...

    @gpuDynamicsConfig.setter
    def gpuDynamicsConfig(self, arg: "physx::PxGpuDynamicsMemoryConfig", /) -> None: ...
    ...
    @property
    def sceneQuerySystem(self) -> "physx::PxSceneQuerySystem": ...

    @sceneQuerySystem.setter
    def sceneQuerySystem(self, arg: "physx::PxSceneQuerySystem", /) -> None: ...
