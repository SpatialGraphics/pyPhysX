...
class QueryFilterCallback(PxQueryFilterCallback):
    def __init__(self, arg0: Callable[[PxFilterData, PxShape, PxRigidActor, "physx::PxFlags<physx::PxHitFlag::Enum, unsigned short>"], PxQueryHitType], arg1: Callable[[PxFilterData, "physx::PxQueryHit", PxShape, PxRigidActor], PxQueryHitType], /) -> None: ...

class UserControllerHitReport(PxUserControllerHitReport):
    def __init__(self, arg0: Callable[["physx::PxControllersHit"], None], arg1: Callable[["physx::PxControllerObstacleHit"], None], arg2: Callable[["physx::PxControllerShapeHit"], None], /) -> None: ...
